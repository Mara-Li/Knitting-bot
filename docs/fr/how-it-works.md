...
- Sinon, le bot enverra un nouveau message avec le *placeholder*[^1] configuré (pour éviter de mentionner les utilisateurs) puis le modifiera avec la liste.

Après avoir envoyé/édité le message, le bot modifiera le message en utilisant le *placeholder* configuré.
